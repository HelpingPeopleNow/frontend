...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'admin.provider.desc': 'Choose which backend the assistant uses. Default = auto fallback chain (Groq → OpenRouter → OpenCode 0 → OpenCode 1 → OpenCode 2 → Mistral → Ollama).',
  ...
  es: {
    ...
    'admin.provider.desc': 'Elige qué backend usa el asistente. Por defecto = cadena de respaldo automática (Groq → OpenRouter → OpenCode 0 → OpenCode 1 → OpenCode 2 → Mistral → Ollama).',
