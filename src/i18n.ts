...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'admin.provider.desc': 'Choose which backend the assistant uses. Default = auto fallback chain (Mistral → OpenCode 1 → OpenCode 2 → Ollama).',
  ...
  es: {
    ...
    'admin.provider.desc': 'Elige qué backend usa el asistente. Por defecto = cadena de respaldo automática (Mistral → OpenCode 1 → OpenCode 2 → Ollama).',
